        ...
        <motion.div 
            ...
            className='w-full max-w-6xl bg-white rounded-3xl shadow-sm border border-gray-200 px-8 py-4 flex justify-between items-center relative'>
                ...
                <div 
                    ...
                    <h1 className='font-semibold text-lg'>Interviewer.ai</h1>
                </div>
                ...
                <div className='flex items-center gap-6 relative'>
                    <div className='relative flex flex-col items-end'>
                        ...
                        {showCreditPopUp && (
                            <motion.div 
                                ...
                                <h3 className='font-semibold text-gray-800 mb-1'>Credits Balance</h3>
                                <p className='text-sm text-gray-500 mb-3'>You have {userData?.credits || 0} credits</p>
                                <button 
                                    onClick={() => {
                                        setShowCreditPopUp(false)
                                        navigate('/pricing')
                    ...
                    <div className='relative flex flex-col items-end'>
                        <button 
                            ...
                            className='w-9 h-9 bg-black text-white rounded-full flex items-center justify-center font-semibold cursor-pointer hover:scale-105 transition'>
